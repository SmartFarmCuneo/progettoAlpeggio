...
USER_SENSORS = {}
USER_INFO = {}
SENSORS_COMPLETED=[] #sensori che hanno rilevato acqua
...
def read_data(ser):
    global latest_sensor_data, INPUT_TOKEN, USER_SENSORS, SENSORS_COMPLETED
    ...
    try:
        ...
        if data['Node_id'] not in SENSORS_COMPLETED:
            ...
            send_to_server(data)
            SENSORS_COMPLETED.append(data['Node_id'])
            ...
            for u in updates:
                ...
                if "message" in u:
                    ...
                    if text == "/start":
                        ...
                        # qui puoi collegarlo al tuo sistema reale
                        # esempio: segnale al server
                        requests.post(
                            SERVER_URL,
                            json={
